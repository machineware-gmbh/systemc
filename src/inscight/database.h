...
protected:
    ...
    virtual void handle_btransport_fw(id_t port, id_t payload, id_t thread, real_time_t rt, sysc_time_t st) = 0;
    virtual void handle_btransport_bw(id_t port, id_t payload, id_t thread, real_time_t rt, sysc_time_t st) = 0;
